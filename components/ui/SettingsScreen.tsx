...
export function SettingsScreen({ onClose }: SettingsScreenProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <div className="bg-slate-900/95 border border-yellow-600/30 rounded-xl max-w-lg w-full shadow-2xl overflow-hidden flex flex-col max-h-full">
                {/* Header */}
                ...
                <div className="flex border-b border-yellow-600/20">
                    {(['audio', 'graphics', 'controls'] as const).map((tab) => (
                        <button
                            ...
                            className={`flex-1 py-3 text-sm font-medium uppercase tracking-wider transition-colors ${activeTab === tab
