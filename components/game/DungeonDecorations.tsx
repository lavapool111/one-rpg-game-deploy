...
// ============== CULLING DISTANCE ==============
const DECORATION_CULL_DISTANCE = 80; // Don't render decorations beyond this distance
...
export function CulledPointLight({
    ...
    const frameCount = useRef(-1); // Start at -1 so first frame (0 % 6 === 0) triggers check
    ...
    return (
        <pointLight
            ...
            distance={distance}
            decay={decay}
            visible={false} // Start hidden, useFrame will manage visibility
        />
    );
}
