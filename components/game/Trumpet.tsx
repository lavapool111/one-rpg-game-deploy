...
export function Trumpet({ id, initialPosition, level = 1, onDeath, pillars = [], arenaRadius = 375 }: TrumpetProps) {
    ...
    useFrame((state, delta) => {
        ...
        if (canSeePlayer && distanceToPlayer > ATTACK_RANGE) {
            const moveDistance = TRUMPET_SPEED * cappedDelta;
            ...
            const wanderSpeed = (TRUMPET_SPEED * 2 / 3) * cappedDelta;
    ...
    return (
        <group ref={groupRef} position={initialPosition}>
            ...
            {/* Health bar above enemy - Only visible when playing and within 175ft */}
